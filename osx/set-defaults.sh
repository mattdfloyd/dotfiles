...
#
# Or, in other words, set it how I like in OS X.
#
...
sudo scutil --set ComputerName "MattBook"
sudo scutil --set HostName "MattBook"
sudo scutil --set LocalHostName "MattBook"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "MattBook"
